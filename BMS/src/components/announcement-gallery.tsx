              ...
              {isLarge ? (
                ...
                <>
                  ...
                  <CardHeader className={isLarge ? "pb-1.5" : "pb-1"}>
                    ...
                    <CardDescription className={`line-clamp-2 ${isLarge ? "text-base" : "text-sm"}`}>
                      {announcement.description}
                    </CardDescription>
                  </CardHeader>
