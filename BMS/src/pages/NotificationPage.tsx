...
import { format } from "date-fns"; // <-- updated helper

export default function ModernNotificationPage() {
  const { data, isLoading, isError } = useEmergencies();

  // Only in-progress emergency alerts
  const emergencyAlerts = data?.filter((e) => e.status === "in_progress") || [];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="rounded-lg p-6">
          ...
          {!isLoading && !isError && emergencyAlerts.length > 0 && (
              ...
              {emergencyAlerts.map((emergency) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-red-600 mt-1">{emergency.location_text}</p>
                  </div>
